...
Crossover
=========
Crossover is the most significant phase in a genetic algorithm. For each pair of parents to be mated, a crossover (Offspring are created by exchanging the genes of parents among themselves until the crossover point is reached) point is chosen at random from within the genes.
